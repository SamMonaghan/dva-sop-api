...
class OsteoarthritisTests extends FunSuite {
  ...
  test("Parse entire RH LS SoP") {
    val result = ParserTestUtils.executeWholeParsingPipeline("F2011C00492", "sops_rh/F2011C00492.pdf")
  ...
  {
    val result = ParserTestUtils.executeWholeParsingPipeline("F2011C00491", "sops_bop/F2011C00491.pdf")
