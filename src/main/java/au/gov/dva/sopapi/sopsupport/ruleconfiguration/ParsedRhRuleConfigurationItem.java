...
public final class ParsedRhRuleConfigurationItem extends ParsedRuleConfigurationItem implements RHRuleConfigurationItem {
    ...
    public ParsedRhRuleConfigurationItem(String conditionName, String instrumentId, String factorRefs, String serviceBranch, String rank, String cftsWeeks, String accumRate, String accumUnit, String rhOperationalDaysRequired, String rhOperationalTestPeriodInYears) {
